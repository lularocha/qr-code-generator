const translations = {
  en: {
    ...
    tipBody:
      '<div class="tip-grid">\
            <span class="tip-num">1.</span><span>Download the QR Code</span>\
            <span class="tip-num">2.</span><span>Point your smartphone camera at the code</span>\
            <span class="tip-num">3.</span><span>Open the link to confirm the text or URL is correct</span>\
          </div>',
  ...
  pt: {
    ...
    tipBody:
      '<div class="tip-grid">\
                <span class="tip-num">1.</span><span>Baixe o QR Code</span>\
                <span class="tip-num">2.</span><span>Aponte a câmera do smartphone para o código</span>\
                <span class="tip-num">3.</span><span>Abra o link para confirmar se o texto ou URL está correto</span>\
              </div>',
